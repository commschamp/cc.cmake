...
list (APPEND CC_TOOLS_QT_DEFAULT_CMAKE_ARGS 
    -DCC_TOOLS_QT_MAJOR_QT_VERSION=${OPT_QT_MAJOR_VERSION} 
    -DCC_TOOLS_QT_USE_CCACHE=${OPT_USE_CCACHE}
    -DCC_TOOLS_QT_CCACHE_EXECUTABLE=${OPT_CCACHE_EXECUTABLE})

list (APPEND CC_DEMO1_PROTOCOL_CC_TOOLS_PLUGIN_DEFAULT_CMAKE_ARGS 
    -DOPT_QT_MAJOR_VERSION=${OPT_QT_MAJOR_VERSION}
    -DOPT_USE_CCACHE=${OPT_USE_CCACHE}
    -DOPT_CCACHE_EXECUTABLE=${OPT_CCACHE_EXECUTABLE})

list (APPEND CC_DEMO2_PROTOCOL_CC_TOOLS_PLUGIN_DEFAULT_CMAKE_ARGS 
    -DOPT_QT_MAJOR_VERSION=${OPT_QT_MAJOR_VERSION}
    -DOPT_USE_CCACHE=${OPT_USE_CCACHE}
    -DOPT_CCACHE_EXECUTABLE=${OPT_CCACHE_EXECUTABLE})

list (APPEND CC_DEMO3_PROTOCOL_CC_TOOLS_PLUGIN_DEFAULT_CMAKE_ARGS 
    -DOPT_QT_MAJOR_VERSION=${OPT_QT_MAJOR_VERSION}
    -DOPT_USE_CCACHE=${OPT_USE_CCACHE}
    -DOPT_CCACHE_EXECUTABLE=${OPT_CCACHE_EXECUTABLE})

list (APPEND CC_MQTT311_PROTOCOL_CC_TOOLS_PLUGIN_DEFAULT_CMAKE_ARGS 
    -DOPT_QT_MAJOR_VERSION=${OPT_QT_MAJOR_VERSION}
    -DOPT_USE_CCACHE=${OPT_USE_CCACHE}
    -DOPT_CCACHE_EXECUTABLE=${OPT_CCACHE_EXECUTABLE})

list (APPEND CC_MQTT5_PROTOCOL_CC_TOOLS_PLUGIN_DEFAULT_CMAKE_ARGS 
    -DOPT_QT_MAJOR_VERSION=${OPT_QT_MAJOR_VERSION}
    -DOPT_USE_CCACHE=${OPT_USE_CCACHE}
    -DOPT_CCACHE_EXECUTABLE=${OPT_CCACHE_EXECUTABLE})

list (APPEND CC_MQTTSN_PROTOCOL_CC_TOOLS_PLUGIN_DEFAULT_CMAKE_ARGS 
    -DOPT_QT_MAJOR_VERSION=${OPT_QT_MAJOR_VERSION}
    -DOPT_USE_CCACHE=${OPT_USE_CCACHE}
    -DOPT_CCACHE_EXECUTABLE=${OPT_CCACHE_EXECUTABLE})

list (APPEND CC_UBLOX_PROTOCOL_CC_TOOLS_PLUGIN_DEFAULT_CMAKE_ARGS 
    -DOPT_QT_MAJOR_VERSION=${OPT_QT_MAJOR_VERSION}
    -DOPT_USE_CCACHE=${OPT_USE_CCACHE}
    -DOPT_CCACHE_EXECUTABLE=${OPT_CCACHE_EXECUTABLE})

list (APPEND CC_MQTT311_CLIENT_FILTER_CC_TOOLS_PLUGIN_DEFAULT_CMAKE_ARGS 
    -DOPT_QT_MAJOR_VERSION=${OPT_QT_MAJOR_VERSION}
    -DOPT_USE_CCACHE=${OPT_USE_CCACHE}
    -DOPT_CCACHE_EXECUTABLE=${OPT_CCACHE_EXECUTABLE})

list (APPEND CC_MQTT5_CLIENT_FILTER_CC_TOOLS_PLUGIN_DEFAULT_CMAKE_ARGS 
    -DOPT_QT_MAJOR_VERSION=${OPT_QT_MAJOR_VERSION}
    -DOPT_USE_CCACHE=${OPT_USE_CCACHE}
    -DOPT_CCACHE_EXECUTABLE=${OPT_CCACHE_EXECUTABLE})

list (APPEND CC_MQTTSN_CLIENT_FILTER_CC_TOOLS_PLUGIN_DEFAULT_CMAKE_ARGS 
    -DOPT_QT_MAJOR_VERSION=${OPT_QT_MAJOR_VERSION}
    -DOPT_USE_CCACHE=${OPT_USE_CCACHE}
    -DOPT_CCACHE_EXECUTABLE=${OPT_CCACHE_EXECUTABLE})
